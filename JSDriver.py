...
from mozillaJSTestSuite.lib.results import NullTestOutput
from mozillaJSTestSuite.lib.tests import TestCase, TBPL_FLAGS
from mozillaJSTestSuite.lib.results import ResultsSink
from mozillaJSTestSuite.lib.progressbar import ProgressBar
...
if sys.platform.startswith('linux') or sys.platform.startswith('darwin'):
    from mozillaJSTestSuite.lib.tasks_unix import run_all_tests
else:
    from mozillaJSTestSuite.lib.tasks_win import run_all_tests
...
def parse_args(js_shell_path=None):
    """
    ...
    if len(args) > 0:
        ...
        if js_shell_path is not None:
            options.js_shell = js_shell_path
